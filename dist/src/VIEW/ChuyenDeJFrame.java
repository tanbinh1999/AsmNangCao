...
public class ChuyenDeJFrame extends javax.swing.JFrame {
    ...
    public boolean check(){
        if (txtmachuyende.getText().isEmpty()) {
            DialogHelper.alert(this, "Mã chuyên đề rỗng!");
            return false;
        }
        if (txttenchuyende.getText().isEmpty()) {
            DialogHelper.alert(this, "Tên chuyên đề rỗng!");
            return false;
        }
        if (txtthoiluong.getText().isEmpty()) {
            DialogHelper.alert(this, "Thời lượng rỗng!");
            return false;
        }
        if (txthocphi.getText().isEmpty()) {
            DialogHelper.alert(this, "Học phí rỗng!");
            return false;
        }
        if (txtmotachuyende.getText().isEmpty()) {
            DialogHelper.alert(this, "Mô tả chuyên đề rỗng!");
            return false;
        }
        if (lblhinh.getToolTipText() == null) {
            DialogHelper.alert(this, "Hình ảnh rỗng!");
            return false;
        }
//        
        return true;
    }
      private boolean checkmacd(JTextField txtmacd){
          if (txtmachuyende.getText().length() == 5) {
              if (dao.checkID(txtmacd.getText())) {
                  return true;
              }else{
                  DialogHelper.alert(this, "Mã chuyên đề trùng!");
              }
            
        }else{
            DialogHelper.alert(this, "Mã chuyên đề đúng 5 kí tự!");
                      }
          return false;
      }
//      private boolean checktencd(JTextField txttencd){
//          if (!txttenchuyende.getText().matches("^[\\p{L}\\s]+$")) {
//               DialogHelper.alert(this, "Tên chuyên đề chỉ chứa alphabet và ký tự trắng!");
//            return false;
//        }
//          return true;
//      }
      private boolean checkthoiluong(JTextField txtthoiluong){
      ...
      private boolean checkhocphi(JTextField txthocphi){
                        ...
                        .addGroup(pnleditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(pnleditLayout.createSequentialGroup()
                                ...
                                .addGroup(pnleditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtmachuyende, javax.swing.GroupLayout.DEFAULT_SIZE, 440, Short.MAX_VALUE)
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        // TODO add your handling code here:
        //        if (checkupdate(btnupdate)) {
            if (check()) {
                //                if (checktencd(txthocphi)) {
                    if (checkthoiluong(txtthoiluong)) {
    ...
    private void btninsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninsertActionPerformed
        ...
        //        if (checkthongtin(btninsert)) {
            if (check()) {
                if (checkmacd(txtmachuyende)) {
                    //                    if (checktencd(txttenchuyende)) {
                        if (checkthoiluong(txtthoiluong)) {
                            if (checkhocphi(txthocphi)) {
                                Insert();
                            }
